...
Make sure install Hugo version `v0.97.3` or major, there are some well-know issues on 0.8X versions.

We recommend get the recent Hugo by brew https://formulae.brew.sh/formula/hugo
