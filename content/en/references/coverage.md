...
Endpoints marked with ✨ are covered by our integration test suite.The 💫 indicates that moto integration tests cover the endpoint, and run succesfully against LocalStack.
