...
| `LAMBDA_DEBUG_MODE` | 0 (default) \| 1 (preview)| Enables or disables the execution of the Lambda function in debug mode, which bypasses the Lambda function's maximum execution timeout and API Gateway's request timeout.|
