...
| `AUTO_LOAD_POD` |  | Comma-separated list of Cloud Pods to be automatically loaded at startup time. This features is disabled when snapshot persistence is set via the `PERSISTENCE` variable. |
