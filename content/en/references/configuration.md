...
| `ECS_TASK_EXECUTOR` | `docker` (default)        | Run ECS tasks using Docker. | 
|                     | `kubernetes` (enterprise) | Run ECS tasks as Kubernetes pods when LocalStack is deployed on Kubernetes. |
