...
If you run LocalStack in a docker container (which includes using [the CLI]({{< ref "/getting-started/installation/#localstack-cli" >}}), [docker]({{< ref "/getting-started/installation/#docker" >}}), [docker-compose]({{< ref "/getting-started/installation/#docker-compose" >}}), [localstack-desktop]({{< ref "/getting-started/installation/#localstack-desktop" >}}) or [helm]({{< ref "/getting-started/installation/#helm" >}})), to include a custom TLS root certificate a new docker image should be created.
