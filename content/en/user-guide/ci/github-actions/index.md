...
While the [`LAMBDA_IGNORE_ARCHITECTURE` configuration]({{< ref "/references/configuration/#lambda" >}}) is an option for cross-architecture compatible Lambdas, it may not be suitable for statically compiled Lambdas.
