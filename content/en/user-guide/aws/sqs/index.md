...
{{<alert>}}
Note that, if you enable this option, [persistence]({{< ref "persistence-mechanism" >}}) or [cloud pods]({{<ref "user-guide/state-management/cloud-pods" >}}) for SQS may not work as expected.
