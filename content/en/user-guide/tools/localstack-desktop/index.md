...
Once it's installed, in case that LocalStack Desktop is being used in a **Windows** environment, it will be required to set the Socket Path to **//./pipe/docker_engine** in the configuration menu.
This is required as Windows uses a different socket path than Linux environments.
