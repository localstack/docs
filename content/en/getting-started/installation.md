...
- Mounting the Docker socket `/var/run/docker.sock` as a volume is required for the Lambda service. See [Lambda Provider Behavioral Changes]({{< ref "lambda-provider-v2" >}}).
