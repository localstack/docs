...
To access the application, go to [**https://webapp.s3-website.localhost.localstack.cloud:4566/**](https://webapp.s3-website.localhost.localstack.cloud/) in your browser.
...
To persist the local cloud resources across restarts, navigate to our [persistence documentation]({{< ref "references/persistence-mechanism" >}}) or learn about [Cloud Pods]({{< ref "user-guide/cloud-pods" >}}), our next generation state management utility.
